...
document.addEventListener('DOMContentLoaded', function() {
  ...
  dados_pagamento.forEach((pagamento) => {
    const total_liq = Intl.NumberFormat('pt-br', {style: 'currency', currency: 'BRL'}).format(pagamento.val_liquido);
    eventsList.push(
      {
        title: total_liq,
  ...
  dados_prev_pagamento.forEach((previsao_pagamento) => {
    const total_liq_prev_pagt = Intl.NumberFormat('pt-br', {style: 'currency', currency: 'BRL'}).format(previsao_pagamento.val_liquido);
