...
function conciliar() {
    ...
    api.post(baseUrl, {
        ...
        const updatedSalesErp = updateData([...salesErp.get('sales')], {
            ...json.erp,
            ID_ERP: json.erp.ID,
...
function closeRetornoErpModal() {
    document.querySelector('#js-retorno-erp-modal #js-data-inicial').valueAsDate = new Date();
    document.querySelector('#js-retorno-erp-modal #js-data-final').valueAsDate = new Date();

    $('#js-retorno-erp-modal').modal('hide');
}

function retornoErp() {
    const dataInicial = document.querySelector('#js-retorno-erp-modal #js-data-inicial').value;
    const dataFinal = document.querySelector('#js-retorno-erp-modal #js-data-final').value;
    ...
    toggleElementVisibility('#js-loader');
    api.get(searchForm.get('form').dataset.urlRetornoErp, {
        params: {
...
document.querySelector('#js-abrir-modal-retorno-erp')
    .addEventListener('click', () => $('#js-retorno-erp-modal').modal('show'));
document.querySelector('#js-cancelar-retorno-erp')
    .addEventListener('click', closeRetornoErpModal);
document.querySelector('#js-retorno-erp-modal *[data-dismiss]')
    .addEventListener('click', closeRetornoErpModal);
