  ...
  var pt = {
    ...
    */
    ...
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'br';
    ...
    function buildDateEnv(settings) {
        var locale = buildLocale(settings.locale || 'br', organizeRawLocales([]).map); // TODO: don't hardcode 'en' everywhere
